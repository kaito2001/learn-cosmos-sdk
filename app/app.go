...
import (
	...
	"vbi-cosmos-basic/docs"
)

const (
	AccountAddressPrefix = "cosmos"
	Name                 = "vbi-cosmos-basic"
)
...
func New(
	...
	*/
	...
	app.VbicosmosbasicKeeper = *vbicosmosbasicmodulekeeper.NewKeeper(
		appCodec,
		keys[vbicosmosbasicmoduletypes.StoreKey],
		keys[vbicosmosbasicmoduletypes.MemStoreKey],
		app.GetSubspace(vbicosmosbasicmoduletypes.ModuleName),
	)
	vbicosmosbasicModule := vbicosmosbasicmodule.NewAppModule(appCodec, app.VbicosmosbasicKeeper, app.AccountKeeper, app.BankKeeper)
